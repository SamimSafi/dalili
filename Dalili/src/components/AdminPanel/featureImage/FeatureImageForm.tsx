...
type LogoFormProps = {
  loadFeatureImage: () => void;
  setToastMessage: (message: string) => void;
  setShowToast: (show: boolean) => void;
  setShow: (show: boolean) => void;
};

export const FeatureImageForm = ({ loadFeatureImage, setShow, setToastMessage, setShowToast }: LogoFormProps) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      .post(baseUrl + '/featureImage', formDataToSend, {
        headers: {
